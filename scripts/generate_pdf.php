...
function Header()
{
    ...
    $this->Cell(80);
    // Title
    $this->Cell(60,15,'Aplicatiile mele',1,0,'C');
    // Line break
    $this->Ln(30);
...
$prop = array('HeaderColor'=>array(255,150,100),
            ...
            'padding'=>2);
$pdf->Table($link,"select NUME, CATEGORIE, RATING, NO_DOWNLOADS, UPLOAD_DATE, COST from apps WHERE ID_UPLOADER='$id_uploader'",$prop);
